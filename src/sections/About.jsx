...
const About = () => {
  return (
    <section id="about" className="relative overflow-hidden bg-slate-50 py-18 text-slate-950 md:py-24">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:gap-14">
          ...
          >
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                to="/about"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-primary px-6 text-sm font-bold text-white shadow-lg shadow-primary/25 transition-all hover:-translate-y-0.5"
              >
                Know More
                <ArrowRight size={17} />
              </Link>
              <Link
                to="/contact"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-6 text-sm font-bold text-slate-700 transition-all hover:-translate-y-0.5 hover:border-primary/30 hover:text-primary"
              >
                Start a Project
              </Link>
            </div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-2xl shadow-slate-900/10">
              <div className="relative aspect-[16/11] overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 right-4 rounded-lg border border-white/15 bg-white/90 p-4 shadow-xl backdrop-blur">
              ...
              <div className="grid gap-0 border-t border-slate-200 md:grid-cols-3">
                {process.map(({ title, desc, icon: Icon }) => (
                  <div key={title} className="border-b border-slate-200 p-5 last:border-b-0 md:border-b-0 md:border-r md:last:border-r-0">
            ...
            <div className="mt-4 flex items-center gap-3 rounded-lg border border-primary/15 bg-white p-4 shadow-sm">
